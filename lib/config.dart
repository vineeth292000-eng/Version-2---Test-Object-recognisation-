...
class AppConfig {
  ...
  // Exposed so SettingsScreen can compare against it directly
  ...
  static int geminiTimeoutSecs = 12;
  ...
  static Future<void> init() async {
    ...
    if (savedKey.isNotEmpty && savedKey != _placeholderKey) {
    ...
    final savedInterval = prefs.getInt('frame_interval_ms');
    if (savedInterval != null) frameIntervalMs = savedInterval;
  }
}
